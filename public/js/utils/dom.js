...
export function getIcon(iconName) {
    const icons = {
        ...
        'wechat': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 6.093-1.98-.255-3.748-4.186-6.206-8.836-6.206zm5.7 3.31a.788.788 0 1 1 0 1.575.788.788 0 0 1 0-1.575zm-5.7 0a.788.788 0 1 1 0 1.575.788.788 0 0 1 0-1.575zm11.309 2.388c-4.589 0-8.255 2.952-8.255 6.616 0 3.663 3.666 6.615 8.255 6.615.716 0 1.424-.09 2.104-.212a.688.688 0 0 1 .57.076l1.517.888a.256.256 0 0 0 .133.042.227.227 0 0 0 .23-.232.473.473 0 0 0-.037-.17l-.308-1.177a.466.466 0 0 1 .168-.527c1.494-1.062 2.394-2.588 2.394-4.303 0-3.664-3.665-6.616-8.255-6.616zm-3.4 2.097a.625.625 0 1 1 0 1.25.625.625 0 0 1 0-1.25zm6.8 0a.625.625 0 1 1 0 1.25.625.625 0 0 1 0-1.25z"/></svg>'
    };
    
    return icons[iconName] || '';
}

export function showToast(title, description = '', duration = 3000) {
